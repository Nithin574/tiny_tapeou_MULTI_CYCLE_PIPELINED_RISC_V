...
async def test_project(dut):
    ...
    dut._log.info(f"Test Case 1: Expected 8, Got {int(dut.uio_out,dut.uo_out)}")    
    assert dut.uio_out == 0 or dut.uo_out == 8#, f"Test Case 1 Failed: Expected 8, Got {int(concatenated_value)}"
